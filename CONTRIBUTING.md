The project is run on Github, in the [typical](http://producingoss.com) free software way - we'd love to accept your patches and contributions to this project. There is just one thing you need to do first.
