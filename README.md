...
This documentation was initiated by [Adam Twardoch](https://github.com/twardoch) and is provided so that other font distributors (webfont providers or package makers) can better utilize the [github.com/google/fonts](https://github.com/google/fonts) repository structure. 
