...
| **Source path** | `apache/mountainsofchristmas/src/` |
...
- **.sfd** (FontForge): MountainsofChristmas-Bold-TTF.sfd, MountainsofChristmas-Regular-TTF.sfd
- **.vfb** (FontLab, proprietary format): MountainsofChristmas-Bold-TTF.vfb, MountainsofChristmas-Regular-TTF.vfb
- Other: METADATA_comments.txt
