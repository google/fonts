...
| **Source path** | `apache/rochester/src/` |
...
- **.sfd** (FontForge): Rochester-Regular-TTF.sfd
- **.vfb** (FontLab, proprietary format): Rochester-Regular.vfb
- Other: METADATA_comments.txt, Rochester-Regular.otf
