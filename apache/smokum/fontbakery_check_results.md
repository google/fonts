...
* HOTFIX: /home/felipe/devel/github_google/fonts/apache/smokum/Smokum-Regular.ttf: Windows-only Opentype-specific StyleName set to "Regular".
...
* ERROR: METADATA.pb full_name="Smokum" does not match post_script_name = "Smokum-Regular"

## METADATA.pb 'filename' matches 'postScriptName' ?
* ERROR: METADATA.pb postScriptName field ends with '-Regular'

## METADATA.pb font.style `normal` matches font internals?
* ERROR: Font macStyle indicates a non-Italic font but nameID 4 ("Smokum") ends with "Italic"

## METADATA.pb lists fonts named canonicaly?
* ERROR: Canonical name in font expected: [[u'Smokum Regular', u'Smokum Italic']] but Smokum
