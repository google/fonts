...
| **Source path** | `apache/syncopate/src/` |
...
- **.vfb** (FontLab, proprietary format): Syncopate-Bold.vfb, Syncopate-Regular.vfb
- Other: METADATA_comments.txt, Syncopate-Bold-VTT.ttf, Syncopate-Regular-VTT.ttf
