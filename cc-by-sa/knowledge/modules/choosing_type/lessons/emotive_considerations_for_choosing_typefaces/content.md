...
In his book, “Stop Stealing Sheep and Find Out How Type Works” (which is now available as a [complete PDF download](https://static.googleusercontent.com/media/fonts.google.com/en/us/knowledge/stop_stealing_sheep.pdf) from Google Fonts), Erik Spiekermann shows a few examples of type set in appropriate typefaces that invoke either trust or distrust from the reader:
