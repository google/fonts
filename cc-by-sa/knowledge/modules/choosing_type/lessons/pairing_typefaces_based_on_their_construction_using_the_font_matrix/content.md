...
[IMG all-sans-serif]
ALT: The word “Ragstone“ shown in three different sans serif typefaces.
CAPTION: These are all sans-serif typefaces (ltr: Source Sans Pro, Helvetica, Outfit). Same genre, but they leave a quite different impression.

[IMG all-serif]
ALT: The word “Ragstone“ shown in three different serif typefaces.
CAPTION: These serif typefaces share the same genre classification as well, and still they appear quite diverse (ltr: Alegreya, Bodoni Moda, Memphis).
...
CAPTION: A three-layer approach for describing typefaces based upon the work of Indra Kupferschmid
...
[IMG form-model-serif]
ALT: A double-story lower case “a” displayed in three different form models in a serif typeface. The dynamic form model has an open aperture. In the rational form model the aperture is closed. The geometric single-story lower case a appears constructed with a circular shape.
CAPTION: The three different form models shown with serif typefaces
...
[IMG form-model-sans-serif]
ALT: A double-story lower case “a” displayed in three different form models in a sans serif typeface. The dynamic form model has an open aperture. In the rational form model the aperture is closed. The geometric single-story lower case a appears constructed with a circular shape.
CAPTION: The three different form models shown with sans-serif typefaces
...
[IMG dynamic--linear-sans]
ALT: A dynamic linear sans serif typeface showing the word “Ragstone”. The open apertures of the lower case a and the diagonal axis in the lower case o are shown.
CAPTION: The dynamic form model comes with open apertures of the e, a, and s, the o diagonally angled (hard to see in sans-serif, set in Source Sans Pro)
...
[IMG rational--linear-sans]
ALT: A rational linear sans serif typeface showing the word “Ragstone”. The closed apertures of the lower case a and the vertical axis in the lower case o are shown.
CAPTION: The shapes of the e, a and s are rather closed, the o shows vertical axis (again, not very obvious in sans serif, set in Helvetica)
...
[IMG geometric--linear-sans]
ALT: A geometric linear sans serif typeface showing the word “Ragstone”. The constructed circular shapes of the lower case a, g, o and e are shown, also the cross shaped lower case t.
CAPTION: Very constructed letter shapes, like the circular o and e, the t is a simple cross (set in Outfit)
...
[IMG all-serif-all-sans-serif--with-form-models]
ALT: The word “Ragstone“ shown in three different sans serif typefaces next to each other in the first line, and three different serif typefaces in the second line. They are arranged in three columns labeled dynamic, rational and geometric.
CAPTION: Knowing about the different form models makes it easier to describe and distinguish the typefaces from before.
...
[IMG dynamic--contrasting-serif]
ALT: A dynamic contrasting serif typeface showing the word “Ragstone”. The open apertures of the lower case a and the diagonal stress in the lower case o are shown.
CAPTION: Describing Alegrya as a dynamic contrasting serif typeface
...
[IMG rational--contrasting-serif]
ALT: A rational contrasting serif typeface showing the word “Ragstone”. The closed apertures of the lower case a and the vertical axis in the lower case o are shown.
CAPTION: Describing Bodoni Moda as a dynamic contrasting serif typeface

The rational linear sans-serif from before turns into a **rational contrasting serif.**

[IMG geometric--contrasting-serif]
ALT: A geometric contrasting serif typeface showing the word “Ragstone”. The constructed circular shapes of the lower case g, o and e, and the circular bowl of the lower case “a” are displayed.
CAPTION: Describing Candida as a geometric contrasting serif typeface
...
[IMG rational--contrasting-serif--addional-descriptors]
ALT: A decorative rational contrasting serif typeface, with inline stokes, trifurcated serifs and thorns that create a spooky impression.
CAPTION: Describing all three layers of the display typeface Rye. You can still see the underlying first two layers, even though the third layer is taking the most attention.
...
[IMG font-matrix]
ALT: The font matrix arranged in three columns and four rows. The three columns show the dynamic, rational and geometric form models. The rows show contrasting sans, contrasting serif, linear sans, and linear serif typefaces.
CAPTION:Typefaces used (ttb) Dynamic: Minerva Modern, Alegreya, Source Sans Pro, and Bitter; Rational: Arya, Bodoni Moda, Helvetica, Zilla Slab; Geometric: Tenor Sans, Candida, Outfit, Memphis
...
[IMG font-matrix--pair-same-form-model]
ALT: The font matrix shown with the columns for the three form models highlighted.
CAPTION: Combine typefaces according to their form model
...
[IMG font-matrix--pair-contrasting]
ALT: The font matrix shown with a diagonal combination of a dynamic contrasting sans with a geometric linear serif typeface.
CAPTION: Go for contrast with very different skeleton and flesh (diagonal combinations)
...
[IMG font-matrix--pair-avoid-same-flesh]
ALT: The font matrix shown with the highlighted row of linear sans typefaces in the different form models
CAPTION: Is it different or is it the same? Avoid combining typefaces from the same row.
...
[IMG look-for-form-models]
ALT: A photo of three different street signs showing typefaces with the different form models.
CAPTION: Try to spot the form model in the wild! Left to right: dynamic, rational, and geometric
...
[IMG combine-fonts-example-step-1-2]
ALT: The word “Ragstone” shown in the dynamic linear serif typeface bitter. It has a diagonal axis and open apertures.
CAPTION: Steps 1 and 2: The primary typeface is Bitter, used for body text. It’s a dynamic linear serif typeface.
...
[IMG combine-fonts-example-step-3-to-5]
ALT: On the left, the typeface “Bitter” is shown as the primary choice used for body text and labeled as “dynamic”. On the right side, the briefing for a secondary typeface used for inline code is written. The typeface should be dynamic linear, and monospace.
CAPTION: Steps 3 to 5: We look for a secondary typeface for inline code, that’s, dynamic, linear and monospace.
...
[IMG combine-fonts-example-step-6]
ALT: On the left, the dynamic typeface “Bitter” is shown. On the right there are three different monospace typefaces in a column as possible candidates. From top to bottom, they are the geometric ”Space Mono“, the rational “JetBrains Mono“, and the dynamic “Fira Code“
CAPTION: Step 6: Our possible candidates and their form models.
...
[IMG roboto-slab--quite-rational]
ALT: The quite rational, linear serif typeface “Roboto Slab” showing the word “Ragstone”. It shows a vertical axis and opened apertures.
CAPTION: From its form model, Roboto Slab does not meet all the criteria of an obvious rational typeface. But overall it still feels quite rational with its narrow proportions and vertical axis.

[IMG exceptions-of-the-matrix]
ALT: Several typefaces shown that will fall out of the matrix.
CAPTION: When it comes to more striking display typefaces, script, handwritten, or blackletter, don’t spend too much energy training to put them into the matrix. They will most likely be very contrasting anyway.
