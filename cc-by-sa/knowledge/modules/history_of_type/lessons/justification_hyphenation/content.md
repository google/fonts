...
Before starting to write, scribes carefully ruled out a rectangular text area on parchment with a sharp tool, lead, or ink. They justified as they wrote, fitting text to the line by hyphenating, abbreviating, overlapping letters, using [ligatures](INSERT_URL), and making slight alterations to the widths of letters. Scribes might allow a letter or two to [protrude into the right margin](INSERT_URL), but on the whole, they went to great lengths to preserve the solid rectangle of the text area, sometimes filling the empty space at the end of a final line with [decoration](INSERT_URL), or even with arbitrary letters.
