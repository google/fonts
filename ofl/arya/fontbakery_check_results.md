...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/arya/Arya-Bold.ttf: Warning: Windows-only Opentype-specific StyleName set to "Regular" as a default value. Please verify if this is correct.
...
## StyleName recommendation
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/arya/Arya-Regular.ttf: Warning: Windows-only Opentype-specific StyleName set to "Regular" as a default value. Please verify if this is correct.
...
* ERROR: METADATA.pb full_name="Arya" does not match post_script_name = "Arya-Regular"
