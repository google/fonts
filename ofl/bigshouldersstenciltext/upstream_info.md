...
**License**: OFL
**METADATA.pb**: `ofl/bigshouldersstenciltext/METADATA.pb`
...
1. The individual PR commits in PR #3435 explicitly state: "Big Shoulders Stencil Text Version 2.001 taken from the upstream repo ... at commit 2f924dd1205484c5e0054b1f3955f434224ba72e"
2. The squash merge commit `4ea17f133` also references `2f924dd`
3. **Binary SHA256 verification**: The file `Big-Shoulders-Stencil/fonts/variable/text/BigShouldersStencilText[wght].ttf` at commit `2f924dd` in upstream has SHA256 `583e3423e62bb853b4970d7b10d44384d179d86e3e96a0bc54103cfbfb96a122`, which exactly matches the current google/fonts file
...
### Config YAML
An override `config.yaml` exists in the google/fonts family directory at `ofl/bigshouldersstenciltext/config.yaml`. It uses a recipe-based build that:
1. Builds from `Big-Shoulders-Stencil/sources/BigShouldersStencil.glyphs`
2. Subspaces to `opsz=10` (text optical size)
3. Renames to "Big Shoulders Stencil Text"

It also builds the SC variant (BigShouldersStencilTextSC) in the same config, using `smcp -> ccmp` remap.
...
source {
  ...
  files { source_file: "Big-Shoulders-Stencil/fonts/variable/text/BigShouldersStencilText[wght].ttf" dest_file: "BigShouldersStencilText[wght].ttf" }
  branch: "master"
}
```
...
- `659780b9a`: "Add config for parent bigshouldersstenciltext too" (override config.yaml added)
- `4ea17f133` (2021-09-08): "Big Shoulders Stencil Text: Version 2.000 added (#3435)" -- squash merge references `2f924dd`
- `5b89f827b`: "Big Shoulders Stencil Text: Version 1.000 added (#2743)" -- initial add from commit `3f1061046298`

### PR #3435
- Title: "Big Shoulders Stencil Text: Version 2.000 added"
...
| Source | SHA256 |
|--------|--------|
| Upstream at `2f924dd` | `583e3423e62bb853b4970d7b10d44384d179d86e3e96a0bc54103cfbfb96a122` |
| google/fonts current | `583e3423e62bb853b4970d7b10d44384d179d86e3e96a0bc54103cfbfb96a122` |
| Upstream at `41153e6` | File path does not exist (`fonts/variable/text/` directory absent) |
...
- `Big-Shoulders-Stencil/fonts/variable/text/BigShouldersStencilText[wght].ttf` exists at this commit
...
- First added as v1.000 from commit `3f10610` (PR #2743), then updated to v2.000 from commit `2f924dd` (PR #3435)
