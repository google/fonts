...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/butcherman/Butcherman-Regular.ttf: Windows-only Opentype-specific StyleName set to "Regular".
...
* ERROR: METADATA.pb full_name="Butcherman" does not match post_script_name = "Butcherman-Regular"
...
* ERROR: Font macStyle indicates a non-Italic font but nameID 4 ("Butcherman") ends with "Italic"

## METADATA.pb lists fonts named canonicaly?
* ERROR: Canonical name in font expected: [[u'Butcherman Regular', u'Butcherman Italic']] but Butcherman
