...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/eater/Eater-Regular.ttf: Windows-only Opentype-specific StyleName set to "Regular".
...
* ERROR: METADATA.pb full_name="Eater" does not match post_script_name = "Eater-Regular"
...
* ERROR: Font macStyle indicates a non-Italic font but nameID 4 ("Eater") ends with "Italic"

## METADATA.pb lists fonts named canonicaly?
* ERROR: Canonical name in font expected: [[u'Eater Regular', u'Eater Italic']] but Eater
