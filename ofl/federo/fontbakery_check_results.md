...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/federo/Federo-Regular.ttf: Windows-only Opentype-specific StyleName set to "Regular".

## Checking with ot-sanitise
* ERROR: ot-sanitise output follows:

ERROR: kern: Too large subtable, table discarded
...
* ERROR: METADATA.pb full_name="Federo" does not match post_script_name = "Federo-Regular"

## METADATA.pb 'filename' matches 'postScriptName' ?
* ERROR: METADATA.pb postScriptName field ends with '-Regular'

## METADATA.pb font.style `normal` matches font internals?
* ERROR: Font macStyle indicates a non-Italic font but nameID 4 ("Federo") ends with "Italic"

## METADATA.pb lists fonts named canonicaly?
* ERROR: Canonical name in font expected: [[u'Federo Regular', u'Federo Italic']] but Federo
