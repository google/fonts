...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/miltonian/Miltonian-Regular.ttf: Warning: Windows-only Opentype-specific StyleName set to "Regular" as a default value. Please verify if this is correct.
...
* ERROR: METADATA.pb full_name="Miltonian" does not match post_script_name = "Miltonian-Regular"
