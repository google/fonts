...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/miltoniantattoo/MiltonianTattoo-Regular.ttf: Warning: Windows-only Opentype-specific StyleName set to "Regular" as a default value. Please verify if this is correct.
...
* ERROR: METADATA.pb full_name="Miltonian Tattoo" does not match post_script_name = "MiltonianTattoo-Regular"
