# Mr Bedfort — Source Investigation
...
- **.vfb** (FontLab, proprietary format): MrBedfort-Regular-OTF.vfb
- **.sfd** (FontForge, not supported by gftools-builder): MrBedfort-Regular-TTF.sfd
- **Compiled binary** (not a design source): MrBedfort-Regular.otf
- **Metadata**: METADATA_comments.txt, METADATA_comments2.txt
