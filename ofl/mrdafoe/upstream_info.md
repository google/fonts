...
- **.vfb** (FontLab, proprietary format): MrDafoe-Regular-OTF.vfb
- **.sfd** (FontForge, not supported by gftools-builder): MrDafoe-Regular-TTF.sfd
- **Compiled binary** (not a design source): MrDafoe-Regular.otf
