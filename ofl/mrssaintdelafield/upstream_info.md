# Mrs Saint Delafield — Source Investigation
...
| **Source path** | `ofl/mrssaintdelafield/src/` |
...
- **.vfb** (FontLab, proprietary format): MrsSaintDelafield-Regular-OTF.vfb
- **.sfd** (FontForge, not supported by gftools-builder): MrsSaintDelafield-Regular-TTF.sfd
- **Compiled binary** (not a design source): MrsSaintDelafield-Regular.otf
