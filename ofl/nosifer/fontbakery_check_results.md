...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/nosifer/Nosifer-Regular.ttf: Windows-only Opentype-specific StyleName set to "Regular".
...
* ERROR: METADATA.pb full_name="Nosifer" does not match post_script_name = "Nosifer-Regular"
...
* ERROR: Font macStyle indicates a non-Italic font but nameID 4 ("Nosifer") ends with "Italic"

## METADATA.pb lists fonts named canonicaly?
* ERROR: Canonical name in font expected: [[u'Nosifer Regular', u'Nosifer Italic']] but Nosifer
