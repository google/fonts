# Noto Sans Malayalam UI - Upstream Source Report
...
Malayalam script UI variant with tighter vertical metrics designed for Android system UI and web interfaces. Noto Sans Malayalam UI is a UI variant of the corresponding Noto Sans family. UI variants use tighter vertical metrics (smaller ascender/descender values) than the standard versions, designed for Android system UI and web interfaces where vertical space is constrained.
...
The commit `090cc7e2cfaa...` was verified by blob-hash comparison: the font binary
...
- repository_url: `https://github.com/googlefonts/noto-fonts` → `https://github.com/notofonts/malayalam`
