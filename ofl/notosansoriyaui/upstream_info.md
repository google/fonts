...
- repository_url: `https://github.com/googlefonts/noto-fonts` → `https://github.com/notofonts/oriya`
...
Note: this family's override config.yaml declares the non-UI source (`familyName: Noto Sans Oriya`); confirm the UI variant is produced as intended during the refresh QA.
