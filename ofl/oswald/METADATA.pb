...
fallbacks {
  ...
  size_adjust_pct: 87.89
  local_src: "Impact"
  ascent_override_pct: 148.44
}
fallbacks {
  axis_target {
    tag: "wght"
...
fallbacks {
  ...
  size_adjust_pct: 75.0
  local_src: "Roboto"
  ascent_override_pct: 175.0
}
fallbacks {
  axis_target {
    tag: "wght"
  ...
  size_adjust_pct: 76.95
  local_src: "Roboto"
  ascent_override_pct: 162.5
}
fallbacks {
  axis_target {
    tag: "wght"
...
fallbacks {
  ...
  size_adjust_pct: 84.77
  local_src: "Roboto"
  ascent_override_pct: 150.0
}
fallbacks {
  axis_target {
    tag: "wght"
  ...
  size_adjust_pct: 87.11
  local_src: "Roboto"
  ascent_override_pct: 145.31
}
fallbacks {
  axis_target {
    tag: "wght"
