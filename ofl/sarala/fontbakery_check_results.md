...
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/sarala/Sarala-Bold.ttf: Warning: Windows-only Opentype-specific StyleName set to "Regular" as a default value. Please verify if this is correct.
...
* ERROR: METADATA.pb: Designer 'Andres Torresi' is not listed in profiles.csv (at 'https://github.com/google/fonts/blob/master/designers/profiles.csv')
...
## StyleName recommendation
* HOTFIX: /home/felipe/devel/github_google/fonts/ofl/sarala/Sarala-Regular.ttf: Warning: Windows-only Opentype-specific StyleName set to "Regular" as a default value. Please verify if this is correct.
...
* ERROR: METADATA.pb full_name="Sarala" does not match post_script_name = "Sarala-Regular"
