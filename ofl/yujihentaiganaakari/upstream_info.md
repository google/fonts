# Yuji Hentaigana Akari — Upstream Source Investigation
...
The upstream repository for Yuji Hentaigana Akari was identified as [https://github.com/Kinutafontfactory/Yuji](https://github.com/Kinutafontfactory/Yuji), which was already recorded in `METADATA.pb`. The source block was missing a `commit` field pointing to a specific upstream revision.
