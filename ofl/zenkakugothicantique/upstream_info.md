# Zen Kaku Gothic Antique — Upstream Source Investigation
...
The upstream repository for Zen Kaku Gothic Antique was identified as [https://github.com/googlefonts/zen-kakugothic](https://github.com/googlefonts/zen-kakugothic), which was already recorded in `METADATA.pb`. The source block was missing a `commit` field pointing to a specific upstream revision.
